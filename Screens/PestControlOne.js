...
export default function PestControlOne({ navigation }) {
    ...
    return (
        <View style={{
            ...
            <View>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontSize: 13, paddingRight: 120 }}>House Size</Text>
                        <Picker
                            selectedValue={selectedBed}
                            onValueChange={(itemValue, itemIndex) =>
                                setSelectedBed(itemValue)
                            }>
                            <Picker.Item label="3000 sq ft - 4000 sq ft" value="one" />
                            <Picker.Item label="3000 sq ft - 4000 sq ft" value="two" />
                            <Picker.Item label="3000 sq ft - 4000 sq ft" value="three" />
                            <Picker.Item label="3000 sq ft - 4000 sq ft" value="four" />
                        </Picker>
                    </View>
                </View>
                <View>
            ...
            <View>
                <TouchableOpacity onPress={() => navigation.navigate('PestControlTwo')}>
                    <View style={{
                        backgroundColor: '#FEE590',
                        borderRadius: 10,
                        alignItems: "center",
