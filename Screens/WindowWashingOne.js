...
export default function WindowWashingOne({ navigation }) {
    ...
    return (
        <View style={{
            ...
            <View>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{ fontSize: 13, paddingRight: 120 }}>Windows</Text>
                        <Picker
                            selectedValue={selectedBed}
                            onValueChange={(itemValue, itemIndex) =>
                                setSelectedBed(itemValue)
                            }>
                            <Picker.Item label="1 - 10" value="one" />
                            <Picker.Item label="1 - 10" value="two" />
                            <Picker.Item label="1 - 10" value="three" />
                            <Picker.Item label="1 - 10" value="four" />
                        </Picker>
                    </View>
                </View>
                <View>
            ...
            <View>
                <TouchableOpacity onPress={() => navigation.navigate('WindowWashingTwo')}>
                    <View style={{
                        backgroundColor: '#FEE590',
                        borderRadius: 10,
                        alignItems: "center",
